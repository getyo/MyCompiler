...
#define FUNCALL(index, paraList,retVal) {\
	switch (index){\
		...
		case 7:{retVal = (int)( &Environmemt::curEnv->EnvGet( ST_ATTR(0) ) ) ; break;}\
		...
		case 11:{retVal = (int)Generator::GenAssign( INT_CONST(0) , INT_ATTR(1) ,INT_ATTR(2) ); break;}\
		case 12:{retVal = (int)Type::CreateArrayType( INT_ATTR(0) , INT_ATTR(1) ); break;}\
